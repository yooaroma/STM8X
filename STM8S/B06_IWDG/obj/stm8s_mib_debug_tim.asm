...
;	./../../mib/stm8s_mib_debug_tim.c: 97: gwMibSec++;
	...
	ldw	_gwMibSec+0, x
00103$:
;	./../../mib/stm8s_mib_debug_tim.c: 99: if(gwMibMiliSec) gwMibMiliSec--;  
...
;	-----------------------------------------
_delay_ms:
;	./../../mib/stm8s_mib_debug_tim.c: 127: gwMibMiliSec = vbDelay;
	clrw	x
	ld	xl, a
	ldw	_gwMibMiliSec+0, x
;	./../../mib/stm8s_mib_debug_tim.c: 128: do {
00103$:
;	./../../mib/stm8s_mib_debug_tim.c: 129: if(gwMibMiliSec==0) break;
	ldw	x, _gwMibMiliSec+0
	jrne	00103$
